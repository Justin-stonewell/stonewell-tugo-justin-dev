...
// import HowToFileAComplaintModal from "../../../components/common/HowToFileAComplaintModal";
import SummaryOfExclusionsModal from "../../../components/common/SummaryOfExclusionsModal";
...
const ProductSelection = (props) => {
  ...
  // How To File a Complaint Dialog
                                      ...
                                      <Grid item container spacing={3}> 
                                              ...
                                              <img
                                                src={values.application.applicationCompany === 'Tugo' 
                                                        ...
                                                        ? allianzLogo : values.application.applicationCompany === 'BlueCross'
                                                            ? blueCrossLogo : values.application.applicationCompany === 'Travelance' ? travelanceLogo 
                                                              : values.application.applicationCompany === 'GMS' ? gmsLogo
                                                                 : values.application.applicationCompany === 'IMG' ? imgLogo : ''}
                                                alt='logo'
                                                style={{width: values.application.applicationCompany === 'Allianz' ? '100px' : values.application.applicationCompany ==='Tugo' ? '110px' : 'auto', height: values.application.applicationCompany ==='BlueCross' ? '70px' : '70px'}}
                                              />
                                          </Grid>
                                          ...
                                          <Grid item container xs={12} sm={9} md={9} spacing={1} style={{ alignSelf:'center' }}>
                                            ...
                                            <div style={{ width:'100%', textAlign: 'center' }}>
                                              ...
                                              {values.application.applicationCompany === 'Allianz'  &&
                                              <IconButton aria-label="view" color="primary" 
                                                onClick={handleClickOpen}
                                              >
                                                <DescriptionIcon />
                                                <Typography variant="body2"  style={{ fontSize: '14px', marginLeft: '3px', fontWeight: '300'  }}>
                                                  <Text tid={'Quote.WhatsNotCovered'}/>
                                                </Typography>
                                              </IconButton>  
                                              }

                                              {/* <HowToFileAComplaintModal
                                                title={<Text tid={`Quote.HowToFileAComplaint`}/>}
                                                company= {values.application.applicationCompany === 'Allianz'? 'Allianz Global Assistance': values.application.applicationCompany}
                                                open={open}
                                                setOpen={setOpen}
                                                okButton={<Text tid={`Dashboard.Close`}/>}
                                                goButton={<Text tid={`Button.GoToFileAComplaint`}/>}
                                              /> */}

                                              <SummaryOfExclusionsModal
                                                title={<Text tid={`Quote.WhatsNotCovered`}/>}
                                                company= {values.application.applicationCompany}
                                                plan= {values.insuredPersons[personInfo.personIndex].eligilbeIns}
                                                open={open}
                                                setOpen={setOpen}
                                                okButton={<Text tid={`Dashboard.Close`}/>}
                                              />
                                        ...
                                        <Grid item container xs={6} sm={4} md={4} style={{ borderTop:'1px solid #ddd' }}> 
                                                ...
                                                <Grid item xs={12} style={{textAlign:'center'}}>
                                                  ...
                                                  <SelectTextFieldSmall
                                                    ...
                                                    onChange={(e) => {
                                                      ...
                                                      // console.log('insurance.coverage.deduct',e.currentTarget.value)

                                                      // When Allianz Canadian Plan, Apply Deductible 
                                                      if(insurance.compnayName === 'Allianz' && values.insuredPersons[personInfo.personIndex].eligilbeIns === 'CANADIAN'){  
                                                        if(e.currentTarget.value > 0){
                                                          setFieldValue(values.insuredPersons[personInfo.personIndex].selectedPlan.insuranceAmount, values.insuredPersons[personInfo.personIndex].selectedPlan.medicalProductDeductValue)
                                                          values.insuredPersons[personInfo.personIndex].selectedPlan.insuranceAmount = values.insuredPersons[personInfo.personIndex].selectedPlan.medicalProductDeductValue
                                                          // console.log('values.insuredPersons[personInfo.personIndex].selectedPlan Deduct', values.insuredPersons[personInfo.personIndex].selectedPlan)
                                                        }else{
                                                          setFieldValue(values.insuredPersons[personInfo.personIndex].selectedPlan.insuranceAmount, values.insuredPersons[personInfo.personIndex].selectedPlan.medicalProductNoDeductValue)
                                                          values.insuredPersons[personInfo.personIndex].selectedPlan.insuranceAmount = values.insuredPersons[personInfo.personIndex].selectedPlan.medicalProductNoDeductValue
                                                          // console.log('values.insuredPersons[personInfo.personIndex].selectedPlan NoDeduct', values.insuredPersons[personInfo.personIndex].selectedPlan)
                                                        }
                                                      }
...

                                          {
                                            ...
                                            <div style={{ display: 'none' }}>
                                              ...
                                              {insurance.compnayName === 'Travelance' ? values.insuredPersons[personInfo.personIndex].selectedPlan.medicalQuestion.answered = true : values.insuredPersons[personInfo.personIndex].selectedPlan.medicalQuestion.answered}
                                              {/* coverage.value */}
                                          ...
                                          <div style={{ display: 'none' }}>

                                            {
                                              ...
                                              */
                                              ...
                                              values.insuredPersons[personInfo.personIndex].tripPeriodDays = 
                                              (insurance.compnayName === 'Tugo' && values.insuredPersons[personInfo.personIndex].eligilbeIns === 'STUDENT' && values.insuredPersons[personInfo.personIndex].tripPeriod <= 10) 
                                                  ? 10
                                                  : (insurance.compnayName === 'Travelance' && values.insuredPersons[personInfo.personIndex].eligilbeIns === 'STUDENT' && values.insuredPersons[personInfo.personIndex].tripPeriod <= 14)
                                                      ? 14
                                                      : values.insuredPersons[personInfo.personIndex].tripPeriod
...

{
                                          ...
                                          <Grid item xs={12} sm={8} md={4} lg={4} style={{ borderTop: '1px solid #ddd', textAlign: 'center'}}>
                                              ...
                                              {((insurance.compnayName === 'Allianz' && values.insuredPersons[personInfo.personIndex].age < 65) || isMedicalQuestionAnswered(values.insuredPersons[personInfo.personIndex].age, insurance) === true)
                                              ? 
                                              <>
                                                ...
                                                {amountFormat(values.insuredPersons[personInfo.personIndex].selectedPlan.insuranceAmount, 2)}
                                                </Typography>
                                                <Typography style={{ fontSize:'14px', fontWeight:'300' }}>
                                                  ...
                                                  {values.inDestination === true 
                                                    ...
                                                    <>
                                                      <br/>
                                                      <Text tid={'Quote.ArrivedAt'}/> {dateFormat(values.insuredPersons[personInfo.personIndex].arrivalDate)} ({CalculateTripDays(values.insuredPersons[personInfo.personIndex].arrivalDate,values.insuredPersons[personInfo.personIndex].tripStartDate)} <Text tid={'Quote.DaysBefore'}/>)
                                                      <br/>
                                                      ...
                                                      {/* Show Waiting Period by Company and arrival date*/}
                                                            {insurance.compnayName === 'Allianz' ? (
                                                                ...
                                                                CalculateTripDays(values.insuredPersons[personInfo.personIndex].arrivalDate,values.insuredPersons[personInfo.personIndex].tripStartDate) - 1 > 29 ? (
                                                                    <> 7 <Text tid={'Quote.Days'} /></>
                                                                ) : (
                                                                    <> 48 <Text tid={'Quote.Hours'} /></>
                                                                )
                                              ...
                                              <div style={{ alignSelf:'center' }}>
                                                ...
                                                {(values.insuredPersons[personInfo.personIndex].eligilbeIns !== 'STUDENT' 
                                                  && (insurance.compnayName !== 'BlueCross' && insurance.compnayName !== 'GMS') 
                                                  && (insurance.compnayName === 'Allianz' ? values.insuredPersons[personInfo.personIndex].age > 64 : values.insuredPersons[personInfo.personIndex].age > 59) 
                                                  && insurance.medicalQuestion.answered === false) &&
                                                  <Typography variant="body2" style={{color:'#3f51b5', marginTop:'1vh', fontWeight:'600'}} >
                                                    * <Text tid={'Quote.MedicalQuestionnaire.Instruction'}/>
                                                  </Typography>
      ...
      {/* Old Medical Questions Allianz Canadian */}
      {/* {
