                ...
                <div>
                  ...
                  {values && values.map((v, index) => (
                     !v.question_code.match(/q02[a-f]/) &&
                      (v.question_code.match('q01') || v.question_code.match('q02'))// 질문 코드가 'q01','q02' 경우에만 렌더링
                        && (
                        <div key={index}>
                          <Grid container>
                            <Grid item xs={12}>
                            ...
                            <Grid item xs={12}>
                              <Typography variant="h5">
                                {v.question_code === 'q01' ? '1.' 
                                 : v.question_code === 'q02' ? '2.'
                                 : null}
                      ...
                      {/* If Question 2 = yes */}
                      {values[1].answer[0].answer_value === true ?
                            <>
                            {values && values.map((v, index) => (
                              v.question_code.match(/q02[a-f]/) && ( 
                                  <div key={index}>
                      ...
                      (v.question_code.match('q03') || v.question_code.match('q04'))// 질문 코드가 'q03','q04' 경우에만 렌더링
                        ...
                        <div key={index}>
                          <Grid container>
                            ...
                            <Grid item xs={12}>
                              <Typography variant="h5">
                                {v.question_code === 'q03' ? '3.'
                                 : v.question_code === 'q04' ? '4.'
                                 : null}
